...
class AuthModule:
    ...
    def _check_rate_limiting(self, client: SessionClient, post_url: str) -> TestResult:
        """Send rapid login attempts and check if server rate-limits."""
        statuses = []
        for _ in range(10):
            try:
    ...
    def _check_username_enumeration(self, client: SessionClient, post_url: str) -> TestResult:
        """Compare responses for valid vs invalid usernames to detect enumeration."""
        try:
